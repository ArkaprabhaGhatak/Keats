    ...
    public static enum Program implements ProgramInterface {
        CollectAlignmentSummaryMetrics {
            @Override public SinglePassSamProgram makeInstance(final String outbase) {
                final net.sf.picard.analysis.CollectAlignmentSummaryMetrics program = new net.sf.picard.analysis.CollectAlignmentSummaryMetrics();
        ...
        CollectInsertSizeMetrics {
            ...
            public SinglePassSamProgram makeInstance(final String outbase) {
                final net.sf.picard.analysis.CollectInsertSizeMetrics program = new net.sf.picard.analysis.CollectInsertSizeMetrics();
