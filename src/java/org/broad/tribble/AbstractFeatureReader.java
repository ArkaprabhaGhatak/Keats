...
public abstract class AbstractFeatureReader<T extends Feature, SOURCE> implements FeatureReader<T> {
    ...
    /**
     * Calls {@link #getFeatureReader(String, org.broad.tribble.FeatureCodec, boolean)} with {@code requireIndex} = true
     */
    ...
    /**
     * {@link #getFeatureReader(String, String, org.broad.tribble.FeatureCodec, boolean)} with {@code null} for indexResource
     * @throws org.broad.tribble.TribbleException
     */
