 ...
 * {@link #decode(SOURCE)} - Reads a {@link org.broad.tribble.Feature} record, provided a {@link SOURCE} pointing at the beginning of a record within the
 * source input.
 * <p/>
 ...
 *
 * @param <FEATURE_TYPE> The type of {@link org.broad.tribble.Feature} this codec generates
...
public interface FeatureCodec<FEATURE_TYPE extends Feature, SOURCE> {
    ...
    /**
     * Decode a single {@link org.broad.tribble.Feature} from the {@link SOURCE}, reading no further in the underlying source than beyond that feature.
     *
     * @param source the input stream from which to decode the next record
     ...
     * more. Otherwise, data that might otherwise be fed into parsing a {@link org.broad.tribble.Feature} may be lost.
     *
    ...
    /**
     * Generates a {@link net.sf.samtools.util.LocationAware} reader of type {@link SOURCE}.  Like {@link #makeSourceFromStream(java.io.InputStream)}, except
     * the {@link net.sf.samtools.util.LocationAware} compatibility is required for creating indexes.
     * 
     * Implementers of this method must return a type that is both {@link net.sf.samtools.util.LocationAware} as well as {@link SOURCE}.  Note that this
