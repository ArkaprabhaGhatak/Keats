...
/**
 * A class that iterates over the lines and line positions in an {@link org.broad.tribble.readers.AsciiLineReader}.
 * 
 * This class is slower than other {@link org.broad.tribble.readers.LineIterator}s because it is driven by {@link org.broad.tribble.readers.AsciiLineReader}, but offers the benefit of
 ...
 * {@link org.broad.tribble.readers.LineIteratorImpl} as an alternative to this class.
 * 
 ...
 * end of the most-recently-returned line (or the start of the underlying {@link org.broad.tribble.readers.AsciiLineReader}, if no line has been read).  The latter
...
public class AsciiLineReaderIterator implements LocationAware, LineIterator, Closeable {
     ...
     * the underlying {@link org.broad.tribble.readers.AsciiLineReader}.
     */
    @Override
